...
using namespace cloudbox::protobuf;
USING_NS_CC;
...
bool HelloWorld::init() {
  ...
  SinglePageInfo *singleInfo = homeInfo.add_result();
  RowInfo *rInfo = singleInfo->add_rows();
  BoxInfo *bInfo = rInfo->add_boxes();
  bInfo->set_id("testId");
  bInfo->set_title("New Box");
